...
# 读取CSV文件并创建图对象
edges <- read.csv("E:\\Dong\\one_drive\\OneDrive - The University Of Hong Kong\\_HMRF_2021_HIGHER_ORDER_MODEL\\movement_1.csv")
edges <- edges[-17, ]
...
# 设置节点的经纬度
V(g)$lon <- c(112.2707,116.4142,117.323,114.9042,112.2922,113.9448,122.6085,126.1923,127.7615,121.4491,119.455,120.0934,117.2264,117.9874,115.7221,118.1498,113.614,111.7088,113.4244,108.7881,109.7453,107.874,102.7103,106.8748,101.487,88.0924,108.8701,104.2861,95.9956,106.1655,85.2401)
V(g)$lat <- c(30.9756,40.1824,39.3054,37.8957,37.5777,44.0935,41.2956,43.6661,47.862,31.202,32.9711,29.1832,31.8257,26.0789,27.614,36.3427,33.882,27.6104,23.3417,23.8298,19.1959,30.0572,30.6171,26.8154,24.974,31.6927,35.1917,35.7518,35.7452,37.2692,41.1129)
