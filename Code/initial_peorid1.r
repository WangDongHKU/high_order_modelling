initial_peorid1 <-  function(dailyincidence, Mobility,p_report) {
  ...
  source("linearfitting_extend_initial.r")
  p1 <- linearfitting_extend_initial((1+cumulative_mobility[location,selected_elements]),(1+dates_20_cases[selected_elements,2]))
  source("linearfitting_extend_initial1.r")
  p2 <- linearfitting_extend_initial1(Deff[location,selected_elements],(1+dates_20_cases[selected_elements,2]))
